    ...
    <div className="bg-neutral-950 border border-neutral-800 rounded-3xl shadow-2xl max-w-full mx-auto overflow-hidden font-sans">
      ...
      <div className="p-8 space-y-6">
        {computedPalettes.map((palette) => (
          <div
            key={palette.id}
            className="bg-neutral-900 p-5 rounded-2xl border border-neutral-800 shadow-sm space-y-4"
          >
            {/* Track Properties */}
              ...
              <div className="flex items-center gap-3 flex-1 max-w-md">
                <div className="flex flex-col space-y-1 flex-1">
                  ...
                  <input
                    ...
                    value={palette.name}
                    onChange={(e) =>
                      updateTrackProp(palette.id, "name", e.target.value)
                    }
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <div className="flex items-center gap-2 bg-neutral-800 px-2.5 py-1.5 rounded-xl border border-neutral-700">
                    <input
                      ...
                      onChange={(e) =>
                        updateTrackProp(palette.id, "seedHex", e.target.value)
                      }
            ...
            >
              {palette.shades.map((shade) => {
                const isSelected =
                  activeEdit?.trackId === palette.id &&
                  activeEdit?.weight === shade.weight;
                return (
                  <div
                    key={shade.weight}
                    onClick={() =>
                  ...
                  >
                    ...
                    <div className="text-center">
                      <div className="text-[10px] font-black text-neutral-200 font-mono">
                        {shade.weight}
                      </div>
                      <div className="text-[8px] font-mono text-neutral-500 uppercase truncate tracking-tighter">
                        {shade.hex}
                      </div>
