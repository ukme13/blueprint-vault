...
- **Data presentation:** Edge-to-edge rows (`Table`, `List/Item`) for dense data. Never wrap list items in `Card`s. Use `Card` _only_ for dashboard widgets, galleries, or settings groups.
